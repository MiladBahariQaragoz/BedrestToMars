...
column names the campaign with the largest error and that error.}
\label{tab:models}
\footnotesize
...
campaign-bootstrap intervals; the dashed line is the logarithmic curve. (b)~Pooled out-of-fold $R^2$. The flexible
families explain two to three times more variance than the curve, yet do not convert it into lower error.}
\label{fig:models}
\end{figure}
...
Reproducibility & Met & One command rebuilds every result; 223 tests pass; tier 3 rebuilt from its cache \\
