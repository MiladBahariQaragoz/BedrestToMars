...
tuning, joined post hoc by a pretrained tabular neural network (TabPFN); and (3)~a post-hoc probabilistic forecast by a language model (TypeSafe's Jev) that reads each held-out
...
3.18 vs.\ 3.16\pp{} out-of-campaign MAE), a null result pre-committed to in advance, and neither did TabPFN
(3.22\pp). The language-model forecast
