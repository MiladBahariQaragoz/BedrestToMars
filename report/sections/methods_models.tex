...
\begin{tikzpicture}[node distance=5mm and 5mm]
  ...
  \node[keybox=4.4cm, minimum height=1.35cm, below=7mm of loco.south, anchor=north] (t2) {\textbf{Tier 2}\\ four ML families vs.\ duration curve\\ \scriptsize out-of-campaign error, SHAP};
...
the validation battery), never by calling the service again. The test suite holds 223 checks in 19 files, including
the deliberately failing leakage test; all 223 passed on 21 September 2026. The figures and tables of this report
are regenerated from the results files by \file{report/make\_figures.py}.
